...
for row in reader:
	...
	processLine = False
	for col in row:
		if (rowCount == 0) or (col in filterValues) :  # <-- Filter on these values (warning: can appear in any column)
			processLine = True
			# print ("Skipping Match:" + col)
...
print('Done! Matches Found: ' + str(matchCount))
